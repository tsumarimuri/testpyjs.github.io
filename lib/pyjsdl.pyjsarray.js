...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	, 1, [null,null,['self'],['other']]);
		...
		$method = $pyjs__bind_method2('mul', function(other) {
			...
			var $iter30_type,$mul24,i,$iter30_nextval,$iter29_type,$iter29_iter,$iter29_idx,$mul23,$iter29_nextval,$iter30_array,$iter29_array,$mul26,$iter30_idx,array,$mul25,ndarray,$iter30_iter;
			array = $p['getattr']($m['Ndarray'], '__typedarray')['__getitem__']($p['getattr'](self, '_dtype'))($p['getattr'](self, '__data'));
			ndarray = $m['Ndarray'](array, $p['getattr'](self, '_dtype'));
			ndarray['_shape'] = $p['getattr'](self, '_shape');
			ndarray['_indices'] = $p['getattr'](self, '_indices');
	...
	, 1, [null,null,['self'],['other']]);
		...
		$method = $pyjs__bind_method2('imul', function(other) {
			...
			var $iter38_iter,$iter37_array,$iter37_idx,i,$iter38_idx,$iter38_nextval,$iter37_type,$mul28,$mul29,$mul27,$iter38_type,$mul30,$iter38_array,$iter37_iter,$iter37_nextval;
			if ($p['bool'](!$p['bool']($p['hasattr'](other, '__iter__')))) {
	...
	, 1, [null,null,['self'],['other']]);
		...
		$method = $pyjs__bind_method2('idiv', function(other) {
			...
			var $iter39_idx,i,$iter40_array,$iter39_array,$div12,$iter39_type,$div13,$iter39_nextval,$div11,$iter39_iter,$div14,$iter40_iter,$iter40_nextval,$iter40_idx,$iter40_type;
			if ($p['bool'](!$p['bool']($p['hasattr'](other, '__iter__')))) {
